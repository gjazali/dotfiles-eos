...
let g:syntax_hi=#{
  ...
  \ Comment        : [s:comment.neutral, 'NONE', 'NONE'],
\ }

" General
" Normal
call Hi(v:true,    'Normal',                s:fg.1,                 s:bg.0,                 'NONE')
...
" Cursor line
hi clear CursorLine
call Hi(v:false,   'CursorLine',            '',                     s:bg.3,                 '')
call Hi(v:false,   'CursorLineNr',          s:fg.4,                 s:bg.3,                 'NONE')
...
" Plugins
" indent-blankline
call Hi(v:true,  'IndentBlanklineChar',    s:bg.5,                 'NONE', 'NONE')
